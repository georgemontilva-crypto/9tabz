    ...
    <AdminLayout title="Products">
      ...
      <div className="mt-6 space-y-4">
        {products.isLoading ? (
          ...
          <div className="rounded-2xl border border-dashed border-neutral-300 p-10 text-center text-sm text-neutral-400">
            No products yet.
          </div>
        )}
      </div>
    ...
    <div className="rounded-2xl border border-neutral-200 bg-white p-5">
      <div className="flex flex-col gap-5 sm:flex-row">
        <div className="shrink-0">
          ...
          <label className="mt-2 block cursor-pointer text-center text-xs font-semibold text-neutral-500 underline underline-offset-2 hover:text-neutral-900">
        ...
        <div className="grid flex-1 gap-4">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <Field label="Slug">
              <input value={product.slug} readOnly className={`${inputClass} bg-neutral-50 text-neutral-500`} />
            </Field>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <button
              ...
              className="ml-auto inline-flex items-center gap-1.5 rounded-xl px-3 py-2.5 text-sm font-semibold text-neutral-400 hover:bg-red-50 hover:text-red-600"
            >
