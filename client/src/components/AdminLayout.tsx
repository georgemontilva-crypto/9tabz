...
export const inputClass =
  "w-full rounded-xl border border-neutral-300 bg-white px-3.5 py-2.5 text-sm outline-none transition focus:border-neutral-900";

export const buttonClass =
  "inline-flex shrink-0 items-center justify-center gap-1.5 rounded-xl bg-neutral-950 px-4 py-2.5 text-sm font-semibold text-white transition-opacity hover:opacity-90 disabled:opacity-50";
